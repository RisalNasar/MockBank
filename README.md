...
`php.ini` file is located at `C:\xampp\php\php.ini`.  Following specific secure configurations where set in `php.ini`.
...
;https://stackoverflow.com/questions/37281111/which-hashing-algorithm-is-used-by-php-session-hash-function-mixed-as-default
session.hash_function=12 ;whirlpool
